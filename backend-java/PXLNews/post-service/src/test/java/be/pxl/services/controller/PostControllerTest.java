    ...
    public class PostControllerTest {
        ...
        public void verifyCreatePostReturnsCreated() throws Exception {
            // Initialize the new PostCreateRequest object with all fields
            PostCreateRequest postCreateRequest = new PostCreateRequest(
                    "New Post",
                    "Post Content",
                    "Author 1",
                    LocalDateTime.now(),  // Ensure creationDate is set
                    Category.FOOD,        // Mock a category
                    State.DRAFT           // Mock a state
            );
        ...
        public void verifyPublishPostReturnsOk() throws Exception {
            ...
            mockMvc.perform(post("/post/{id}/publish", postId))
                    .andExpect(status().isOk());
